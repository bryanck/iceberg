...
public class Coordinator extends Channel {
  ...
  private static final String OFFSETS_SNAPSHOT_PREFIX = "kafka.connect.offsets.";
  ...
  public Coordinator(
    ...
    this.snapshotOffsetsProp =
        OFFSETS_SNAPSHOT_PREFIX
            + Joiner.on('.').join(config.controlTopic(), config.controlGroupId());
